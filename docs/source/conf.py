# -*- coding: utf-8 -*-
#
# diablo2_doc documentation build configuration file, created by
...
version = diablo2_doc.__version__
# The full version, including alpha/beta/rc tags.
release = diablo2_doc.__version__
...
html_logo = "./_static/diablo2_doc-logo.png"
html_favicon = "./_static/diablo2_doc-favicon.ico"
...
htmlhelp_basename = 'diablo2_docdoc'
...
latex_documents = [
    (master_doc, 'diablo2_doc.tex', 'diablo2_doc Documentation',
     u'Sanhe Hu', 'manual'),
]
...
man_pages = [
    (master_doc, 'diablo2_doc', 'diablo2_doc Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'diablo2_doc', 'diablo2_doc Documentation',
     author, 'diablo2_doc', 'One line description of project.',
     'Miscellaneous'),
]
...
package_name = diablo2_doc.__name__
